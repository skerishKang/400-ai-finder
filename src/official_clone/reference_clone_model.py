...
# these generic CMS template class tokens (NOT site literals such as a specific
# municipality, service name, or phone number) and never embeds raw source HTML — only source-backed text is
