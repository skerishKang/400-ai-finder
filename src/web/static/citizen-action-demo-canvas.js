          ...
          '<main class="bg-content bg-content--sub" id="bg-content-main">' +
            ...
            '<div class="bg-apartment-results">' +
              ...
              '<table class="bg-apartment-table">' +
                ...
                '<tbody>' +
                  '<tr>' +
                    '<td>1</td><td>제일맨션</td><td>광주 북구 오치동</td><td>1997-07-16</td><td>3</td><td>7</td><td>72</td><td>062-123-4567</td>' +
                  '</tr>' +
                  '<tr>' +
                    '<td>2</td><td>오치아파트</td><td>광주 북구 오치동</td><td>1988-02-22</td><td>5</td><td>5</td><td>120</td><td>062-234-5678</td>' +
                  '</tr>' +
                  '<tr>' +
                    '<td>3</td><td>송광아파트</td><td>광주 북구 두암동</td><td>1990-05-10</td><td>4</td><td>10</td><td>160</td><td>062-345-6789</td>' +
                  '</tr>' +
                  '<tr>' +
                    '<td>4</td><td>두암아파트</td><td>광주 북구 두암동</td><td>1985-12-30</td><td>6</td><td>5</td><td>180</td><td>062-456-7890</td>' +
                  '</tr>' +
                '</tbody>' +
              '</table>' +
            '</div>' +
