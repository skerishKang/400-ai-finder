...
(function () {
  ...
  var JOURNEY_MAP = Object.freeze({
    ...
    "공동주택 관련 문의는 어느 부서에 해야 하나요?": Object.freeze({
      ...
      steps: Object.freeze([
        Object.freeze({ message: "북구소개 메뉴로 이동합니다.", delayMs: 600 }),
        Object.freeze({ message: "구청안내를 확인합니다.", delayMs: 800 }),
        Object.freeze({ message: "업무 및 전화번호 안내 화면으로 이동합니다.", delayMs: 800 }),
        Object.freeze({ message: "도시관리국 > 공동주택과 정보를 확인합니다.", routeId: "apartment-dept", delayMs: 1500, cursorTarget: ".bg-dept-result__card" }),
