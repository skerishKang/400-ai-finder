...
- Candidate commit (renderer candidate under review by this evidence): `4dab7b55d81927964e2807d82260dbb2ee6dee1e`
...
- clone screenshot: local offline full-page at matched viewport, SHA-256 2cd500cf0ba956f8….
- side-by-side: `data/official_clone_reviews/seogu/g3/4dab7b55d81927964e2807d82260dbb2ee6dee1e/states/notice.list.desktop/side_by_side.png`, SHA-256 b5ef646b02de8631….
...
- clone screenshot: local offline full-page at matched viewport, SHA-256 2035a5bb0a506bbc….
- side-by-side: `data/official_clone_reviews/seogu/g3/4dab7b55d81927964e2807d82260dbb2ee6dee1e/states/notice.detail.desktop/side_by_side.png`, SHA-256 490b8acb00f5c247….
- external network count: **0** (non-loopback requests aborted + counted).
...
- clone screenshot: local offline full-page at matched viewport, SHA-256 77794796b11ae347….
- side-by-side: `data/official_clone_reviews/seogu/g3/4dab7b55d81927964e2807d82260dbb2ee6dee1e/states/gosi.list.desktop/side_by_side.png`, SHA-256 7f54f5896d10c244….
- external network count: **0** (non-loopback requests aborted + counted).
- source parity: structural=`NOT_ASSESSED`, content=`NOT_ASSESSED`, asset=`FAIL`, interaction_nav=`NOT_ASSESSED`, responsive=`NOT_ASSESSED`, a11y=`NOT_ASSESSED`, visual=`DIFFER`.
- source parity structural/content = NOT_ASSESSED: committed automated source-vs-clone comparison evidence is insufficient; no PASS is claimed (fail-closed). Owner visual review pending.
...
- clone screenshot: local offline full-page at matched viewport, SHA-256 44e8f75455b8afe7….
- side-by-side: `data/official_clone_reviews/seogu/g3/4dab7b55d81927964e2807d82260dbb2ee6dee1e/states/gosi.detail.desktop/side_by_side.png`, SHA-256 c37c4b3dfbd73027….
- external network count: **0** (non-loopback requests aborted + counted).
- source parity: structural=`NOT_ASSESSED`, content=`NOT_ASSESSED`, asset=`FAIL`, interaction_nav=`NOT_ASSESSED`, responsive=`NOT_ASSESSED`, a11y=`NOT_ASSESSED`, visual=`DIFFER`.
- source parity structural/content = NOT_ASSESSED: committed automated source-vs-clone comparison evidence is insufficient; no PASS is claimed (fail-closed). Owner visual review pending.
...
- clone screenshot: local offline full-page at matched viewport, SHA-256 3b5323f5bcdae573….
- side-by-side: `data/official_clone_reviews/seogu/g3/4dab7b55d81927964e2807d82260dbb2ee6dee1e/states/civil_form.list.desktop/side_by_side.png`, SHA-256 d51352a107df165e….
- external network count: **0** (non-loopback requests aborted + counted).
- source parity: structural=`NOT_ASSESSED`, content=`NOT_ASSESSED`, asset=`FAIL`, interaction_nav=`NOT_ASSESSED`, responsive=`NOT_ASSESSED`, a11y=`NOT_ASSESSED`, visual=`DIFFER`.
- source parity structural/content = NOT_ASSESSED: committed automated source-vs-clone comparison evidence is insufficient; no PASS is claimed (fail-closed). Owner visual review pending.
...
- clone screenshot: local offline full-page at matched viewport, SHA-256 ddacdfff4e3ea4fc….
- side-by-side: `data/official_clone_reviews/seogu/g3/4dab7b55d81927964e2807d82260dbb2ee6dee1e/states/civil_form.detail.desktop/side_by_side.png`, SHA-256 8433ae05203d933a….
- external network count: **0** (non-loopback requests aborted + counted).
- source parity: structural=`NOT_ASSESSED`, content=`NOT_ASSESSED`, asset=`FAIL`, interaction_nav=`NOT_ASSESSED`, responsive=`NOT_ASSESSED`, a11y=`NOT_ASSESSED`, visual=`DIFFER`.
- source parity structural/content = NOT_ASSESSED: committed automated source-vs-clone comparison evidence is insufficient; no PASS is claimed (fail-closed). Owner visual review pending.
