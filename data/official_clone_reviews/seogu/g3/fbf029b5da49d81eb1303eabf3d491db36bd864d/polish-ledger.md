...
Candidate commit: `fbf029b5da49d81eb1303eabf3d491db36bd864d`
...
| 6 | Emblem / logo | real logo image bytes not committed (`TECHNICAL_CAPTURE_GAP`, SHA-256 `98a13374…`) | unchanged (asset gate — no AI/fake logo) |
...
- This is **not** caused by an asset gate `#1234`, a rights block, or "no image
  exists". `#1234` is separate future Production/public-release governance and is
  not causal to this Phase-A fidelity gap.
...
- notice.detail body poster image (TECHNICAL_CAPTURE_GAP; not a #1234 gate).
- Any board data model, routing, or G2-A semantic content.

## Verification

- `pytest tests/test_reference_clone_renderer.py` — 85 passed (incl. 4 new regressions).
- `pytest tests/test_reference_clone_renderer_board_candidate_gate.py` — passed.
...
- Evidence: fresh 6-state capture (chromium 145.0.7632.116, Playwright 1.61.0)
  at `data/official_clone_reviews/seogu/g3/fbf029b5da49d81eb1303eabf3d491db36bd864d/`,
