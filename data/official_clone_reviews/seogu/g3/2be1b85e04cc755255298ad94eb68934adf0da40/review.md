...
## State matrix (qualitative, no pixel-similarity auto-approval)

| # | state_id | viewport | clone route | ext.req | structural | content | assets | interaction | responsive | a11y | visual |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | `home.desktop.default` | 1440x900 | `/seogu/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |
| 2 | `home.mobile.default` | 390x844 | `/seogu/home/mobile/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |
| 3 | `home.desktop.gnb_open` | 1440x900 | `/seogu/home/gnb-open/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |
| 4 | `notice.list.desktop` | 1440x900 | `/seogu/notice/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |
| 5 | `notice.detail.desktop` | 1440x900 | `/seogu/notice/detail/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |
| 6 | `gosi.list.desktop` | 1440x900 | `/seogu/gosi/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |
| 7 | `gosi.detail.desktop` | 1440x900 | `/seogu/gosi/detail/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |
| 8 | `civil_form.list.desktop` | 1440x900 | `/seogu/civil-form/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |
| 9 | `civil_form.detail.desktop` | 1440x900 | `/seogu/civil-form/detail/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |
| 10 | `organization.chart.desktop` | 1440x900 | `/seogu/organization/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |
| 11 | `staff.directory.desktop` | 1440x900 | `/seogu/staff/` | 0 | PASS | PASS | FAIL | PASS | PASS | PASS | DIFFER |

Legend: **PASS** = modeled contract satisfied; **FAIL** = known deviation (see Exceptions); **DIFFER** = material visual/material difference from the real source. This matrix is NOT an auto-approval: no pixel-similarity threshold is applied; `visual_review` stays `pending`.
...
- **assets = FAIL**: `asset_byte_fidelity_complete=false` — the clone renders structural placeholders only; no real Seo-gu asset bytes (images/fonts/css) are fetched or committed.
- **visual/material = DIFFER (expected G2-B)**: source is the real municipal site with full visual styling, photographs, fonts and iconography; clone is the modeled layout tokens only.
- structural/content/interaction/responsive/a11y: PASS at the modeled schema level (header/nav/main/footer, GNB toggle, list->detail, inert attachments, no overflow, focus).
