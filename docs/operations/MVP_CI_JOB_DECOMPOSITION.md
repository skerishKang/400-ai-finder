...
This slice changes CI orchestration only. It does **not** weaken assertions, remove tests, add skips/xfails, change browser thresholds, or replace deterministic/offline fixtures with live network calls.

## Historical baseline

A green pre-split PR run (`31354508444`, job `93351556015`) ran from approximately `2026-08-10T04:07:14Z` to `2026-08-10T04:19:46Z`, about **12m32s wall-clock** for the single job. This is evidence for the serial baseline, not a promised post-split target.
