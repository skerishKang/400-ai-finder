...
| 파일 | 설명 |
|------|------|
| [`bukgu-golden-compatibility-manifest.md`](bukgu-golden-compatibility-manifest.md) | Buk-gu golden 호환성 매니페스트 — freeze 계약 (routes/APIs/CI/safety) |
| [`architecture/clone-first-platform-adr.md`](architecture/clone-first-platform-adr.md) | Clone-first 플랫폼 ADR — Buk-gu golden first, multi-site 추출 원칙 |
...
| 경로 | 역할 |
|------|------|
| [`artifacts/1109-stage3-comparison/comparison-evidence.json`](artifacts/1109-stage3-comparison/comparison-evidence.json) | **Canonical** offline Stage 3 / Phase B comparison evidence |
| [`page-agent-stage3-comparison-report.md`](page-agent-stage3-comparison-report.md) | **Canonical** public-safe comparison report |
| [`artifacts/1145-phase-b/phase-b-notes.md`](artifacts/1145-phase-b/phase-b-notes.md) | Supporting Phase B notes (points at 1109 evidence) |
| [`artifacts/1145-phase-a/`](artifacts/1145-phase-a/) | **Historical only** — do not rewrite as current |

Golden freeze SHA and closed contracts: [`bukgu-golden-compatibility-manifest.md`](bukgu-golden-compatibility-manifest.md).
