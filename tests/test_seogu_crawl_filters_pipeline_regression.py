"""No-live pipeline regression tests for seogu_gwangju crawl_filters config.

All tests use mock/static HTML only. No real network/API/Firecrawl calls.
Validates that real seogu profile filters load and preserve/deny expected URLs
...
# ------------------------------------------------------------------
# Static HTML fixtures for seogu_gwangju profile filter testing
# ------------------------------------------------------------------
...
<html>
  <head>
    ...
    <meta name="description" content="광주광역시 서구청 공식 홈페이지">
  </head>
  <body>
    <nav>
      <!-- Survive: protected patterns (mid=, menuId=, board.es, seq=, contentId=, articleId=) -->
      <a href="/menu.es?mid=a101">시정소식</a>
      ...
      <a href="/menu.es?mid=a202">민원안내</a>
      <a href="/menu.es?mid=a303">복지정보</a>
    </nav>
  </body>
</html>
"""
...
EXPECTED_SURVIVE_URLS = [
    "https://seogu.gwangju.kr/menu.es?mid=a101",
    "https://seogu.gwangju.kr/board.es?seq=999",
    "https://seogu.gwangju.kr/content?contentId=123",
    "https://seogu.gwangju.kr/article?articleId=777",
    "https://seogu.gwangju.kr/board.es?pageNo=2",
    "https://seogu.gwangju.kr/menu.es?mid=a202",
    "https://seogu.gwangju.kr/menu.es?mid=a303",
]

EXPECTED_DENY_URLS = [
    "https://seogu.gwangju.kr/page?print=1",
    "https://seogu.gwangju.kr/page?utm_source=test",
    "https://seogu.gwangju.kr/page?utm_campaign=spring",
]
...
class TestSeoguProfileFiltersLoaded:
    """Test that real seogu_gwangju profile crawl_filters load correctly."""

    def test_seogu_profile_loads_with_crawl_filters(self):
        """SiteProfileLoader loads seogu_gwangju with non-empty crawl_filters."""
        loader = SiteProfileLoader()
        profile = loader.load_by_id("seogu_gwangju")

        assert profile.site_id == "seogu_gwangju"
        assert profile.base_url == "https://seogu.gwangju.kr/"
        assert profile.crawl_filters is not None
        assert isinstance(profile.crawl_filters, dict)

    def test_seogu_crawl_filters_not_empty(self):
        """seogu_gwangju crawl_filters must not be empty (Stage 400 applied)."""
        loader = SiteProfileLoader()
        profile = loader.load_by_id("seogu_gwangju")
    ...
    def test_seogu_deny_patterns_match_conservative_candidate(self):
        """deny_patterns match the conservative candidate exactly."""
        loader = SiteProfileLoader()
        profile = loader.load_by_id("seogu_gwangju")
        deny = profile.crawl_filters.get("deny_patterns", [])

        # Conservative candidate deny patterns
    ...
    def test_seogu_protected_patterns_match_conservative_candidate(self):
        """protected_patterns match the conservative candidate exactly."""
        loader = SiteProfileLoader()
        profile = loader.load_by_id("seogu_gwangju")
        protected = profile.crawl_filters.get("protected_patterns", [])

        # Conservative candidate protected patterns
    ...
    def test_seogu_allow_patterns_empty(self):
        """allow_patterns intentionally empty per conservative design."""
        loader = SiteProfileLoader()
        profile = loader.load_by_id("seogu_gwangju")
    ...
    def test_seogu_forbidden_deny_guard(self):
        """Critical parameters forbidden in deny_patterns (guard)."""
        loader = SiteProfileLoader()
        profile = loader.load_by_id("seogu_gwangju")
        deny = profile.crawl_filters.get("deny_patterns", [])
...
class TestSeoguFiltersPreserveAndDenyExpectedLinks:
    """Test URL filtering behavior with static HTML using real seogu filters."""

    @pytest.fixture
    def real_seogu_filters(self):
        """Load real seogu_gwangju crawl_filters from profile."""
        loader = SiteProfileLoader()
        profile = loader.load_by_id("seogu_gwangju")
        return profile.crawl_filters

    @pytest.fixture
    def crawler_with_seogu_filters(self, real_seogu_filters):
        """URLCrawler initialized with real seogu crawl_filters."""
        return URLCrawler(crawl_filters=real_seogu_filters)

    def test_seogu_static_html_protected_urls_survive(self, crawler_with_seogu_filters):
        ...
        links = crawler_with_seogu_filters.extract_links(soup, base_url)
    ...
    def test_seogu_static_html_tracking_and_print_denied(self, crawler_with_seogu_filters):
    ...
    def test_seogu_pagination_deferred_survives(self, crawler_with_seogu_filters):
        ...
        assert "https://seogu.gwangju.kr/board.es?pageNo=1" in urls
        assert "https://seogu.gwangju.kr/board.es?pageNo=2" in urls
        assert "https://seogu.gwangju.kr/board.es?pageNo=50" in urls
        assert len(urls) == 3

    def test_should_crawl_url_with_real_filters(self, real_seogu_filters):
        """should_crawl_url pure function works with real seogu filters."""
        # Protected patterns -> allow
        assert should_crawl_url("https://seogu.gwangju.kr/menu.es?mid=a101", real_seogu_filters) is True
        assert should_crawl_url("https://seogu.gwangju.kr/board.es?seq=999", real_seogu_filters) is True
        assert should_crawl_url("https://seogu.gwangju.kr/content?contentId=123", real_seogu_filters) is True
        assert should_crawl_url("https://seogu.gwangju.kr/article?articleId=777", real_seogu_filters) is True

        # pagination deferred -> allow
        assert should_crawl_url("https://seogu.gwangju.kr/board.es?pageNo=2", real_seogu_filters) is True
        assert should_crawl_url("https://seogu.gwangju.kr/board.es?currentPage=3", real_seogu_filters) is True

        # deny patterns -> deny
        assert should_crawl_url("https://seogu.gwangju.kr/page?print=1", real_seogu_filters) is False
        assert should_crawl_url("https://seogu.gwangju.kr/page?utm_source=test", real_seogu_filters) is False
        assert should_crawl_url("https://seogu.gwangju.kr/page?utm_medium=email", real_seogu_filters) is False
        assert should_crawl_url("https://seogu.gwangju.kr/page?utm_campaign=spring", real_seogu_filters) is False

    def test_homepage_mapper_with_seogu_filters_static_html(self, real_seogu_filters):
        """HomepageMapper with seogu filters processes static HTML correctly.
        ...
        mapper = HomepageMapper(
            fetch_provider="mock",
            crawl_filters=real_seogu_filters,
        )

        # Mock the fetch to return our static HTML
        with patch.object(mapper, "fetch_content") as mock_fetch:
            mock_fetch.return_value = (SEOGU_HOMEPAGE_HTML, None, 200, "https://seogu.gwangju.kr/")

            result = mapper.build_map("https://seogu.gwangju.kr/")
...
# ------------------------------------------------------------------
# Test C: PipelineRunner passes seogu filters to HomepageMapper no-live
# ------------------------------------------------------------------

FAKE_HOMEPAGE_MAP = {
    "start_url": "https://seogu.gwangju.kr/",
    "base_url": "https://seogu.gwangju.kr/",
    "sitemap": {"candidates": [], "found": [], "url_count": 0, "urls": [], "errors": []},
    "homepage": {
        "title": "광주광역시 서구청",
        "description": "광주광역시 서구청 공식 홈페이지",
        "navigation_links": [
            {"text": "시정소식", "url": "https://seogu.gwangju.kr/menu.es?mid=a101", "category": "menu"},
            {"text": "고시공고", "url": "https://seogu.gwangju.kr/board.es?seq=999", "category": "board"},
            {"text": "콘텐츠", "url": "https://seogu.gwangju.kr/content?contentId=123", "category": "notice"},
            {"text": "기사", "url": "https://seogu.gwangju.kr/article?articleId=777", "category": "notice"},
            {"text": "게시판2", "url": "https://seogu.gwangju.kr/board.es?pageNo=2", "category": "board"},
        ],
        "attachment_links": [],
        "errors": [],
    },
    "categories": {
        "menu": ["https://seogu.gwangju.kr/menu.es?mid=a101"],
        "notice": [
            "https://seogu.gwangju.kr/content?contentId=123",
            "https://seogu.gwangju.kr/article?articleId=777",
        ],
...
class TestPipelineRunnerPassesSeoguFiltersToHomepageMapper:
    """Test PipelineRunner no-live path with real seogu profile filters."""
    ...
    def test_pipeline_runner_passes_seogu_filters_to_homepage_mapper(
        ...
        # Configure mocks
        MockLoader.return_value.list_ids.return_value = ["seogu_gwangju", "gwangju_go_kr", "bukgu_gwangju"]
        ...
        MockIndexer.return_value.build_index.return_value = [
            {
                "id": "doc-000001",
                "url": "https://seogu.gwangju.kr/menu.es?mid=a101",
                "canonical_url": "https://seogu.gwangju.kr/menu.es?mid=a101",
                "title": "시정소식",
                "category": "menu",
        ...
        MockComposer.return_value.compose.return_value = {
            ...
            "model": "mock-model",
            "ok": True,
            "answer_markdown": "## 답변\n\n시정소식 페이지 확인하세요.\n\n## 관련 자료\n\n- [시정소식](https://seogu.gwangju.kr/menu.es?mid=a101)\n\n## 다음에 할 일\n\n1. 안내 페이지 확인\n\n## 확인 필요 사항\n\n없음",
            "sources": [
                {
                    "rank": 1,
                    "id": "doc-000001",
        ...
        result = runner.run(url="https://seogu.gwangju.kr/", query="시정소식 안내")
